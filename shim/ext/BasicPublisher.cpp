...
int main(int argc, char** argv)
{
    ...
    try
    {
        ...
        {
#if _MSC_VER
            const int messageLen = ::sprintf_s(message, sizeof(message), "{\":onyx/fn\":\"inc\",\":onyx/params\":[%d]}", i);
#else
            const int messageLen = ::snprintf(message, sizeof(message), "{\":onyx/fn\":\"inc\",\":onyx/params\":[%d]}", i);
#endif
